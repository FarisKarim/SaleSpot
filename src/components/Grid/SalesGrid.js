  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4 place-items-center">
      {items.map((item, index) => (
        <div key={index} className="w-72 sm:w-full p-4 bg-indigo-500 border-4 border-black rounded-lg shadow dark:bg-indigo-800 dark:border-black hover:scale-110 transition-transform">
